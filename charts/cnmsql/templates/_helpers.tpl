...
*/}}
{{- define "cnmsql.resourceName" -}}
{{- $fullname := include "cnmsql.fullname" .context }}
{{- $suffix := .suffix }}
...
*/}}
{{- define "cnmsql.serviceAccountName" -}}
{{- if and (not (.Values.serviceAccount.enable | default true)) .Values.serviceAccount.name }}
{{- .Values.serviceAccount.name }}
{{- else }}
{{- include "cnmsql.resourceName" (dict "suffix" "controller-manager" "context" .) }}
{{- end }}
{{- end }}
